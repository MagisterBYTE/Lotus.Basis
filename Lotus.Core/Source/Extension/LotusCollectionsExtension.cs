...
namespace Lotus.Core
{
	...
	*@{*/
    ...
    public static class XCollectionsExtension
    {
        ...
        /// <summary>
        /// Перечисление только не нулевых элементов коллекции.
        /// </summary>
        /// <typeparam name="TItem">Тип элемента коллекции.</typeparam>
        /// <param name="this">Коллекция.</param>
        ...
        #region IList<Single> 
        /// <summary>
        /// Получить индекс элемента список значение которого на более близко указанному аргументу.
        /// </summary>
        /// <param name="this">Список.</param>
        ...
        /// <summary>
        /// Получить значение элемента списка значение которого на более близко указанному аргументу.
        /// </summary>
        /// <param name="this">Список.</param>
        /// <param name="value">Значение.</param>
