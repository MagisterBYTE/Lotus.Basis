...
namespace Lotus.Core.Inspector
{
	...
	*@{*/
...
#endif
    {
        ...
        public LotusHeaderGroupBoxAttribute(string name, int indent)
        {
            _name = name;
            _indent = indent;
        }
        ...
        public LotusHeaderGroupBoxAttribute(string name, uint colorBGRA, string textAlignment = "MiddleLeft")
        {
            _name = name;
        ...
        /// <param name="textAlignment">Выравнивание текста заголовка.</param>
        public LotusHeaderGroupBoxAttribute(string name, uint colorBGRA, int ord, string textAlignment = "MiddleLeft")
        {
            _name = name;
            _textColor = TColor.FromBGRA(colorBGRA);
            _textAlignment = textAlignment;
