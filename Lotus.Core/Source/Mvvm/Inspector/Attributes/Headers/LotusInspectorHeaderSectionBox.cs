...
namespace Lotus.Core.Inspector
{
	...
	*@{*/
...
#endif
    {
        ...
        public LotusHeaderSectionBoxAttribute(string name, uint colorBGRA, string textAlignment = "MiddleLeft")
        {
            _name = name;
        ...
        /// <param name="textAlignment">Выравнивание текста заголовка.</param>
        public LotusHeaderSectionBoxAttribute(string name, uint colorBGRA, int ord, string textAlignment = "MiddleLeft")
        {
            _name = name;
            _textColor = TColor.FromBGRA(colorBGRA);
            _textAlignment = textAlignment;
