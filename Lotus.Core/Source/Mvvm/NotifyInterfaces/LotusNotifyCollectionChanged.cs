...
namespace Lotus.Core
{
	...
	*@{*/
    ...
    public enum TNotifyCollectionChangedAction
    {
        ...
        /// - Индекс элемента - указывается предыдущая позиция элемента
        /// - Количество элементов - указывается новая позиция элемента
        /// </remarks>
        Move,
        ...
        /// </summary>
        /// <remarks>
        /// Применяется только для элементов которые имеют сложный тип
        /// Описание аргументов:
