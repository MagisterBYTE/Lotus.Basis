...
//---------------------------------------------------------------------------------------------------------------------
/** \file LotusViewModelCommon.cs
*		Определение общих типов и структур данных подсистемы ViewModel.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
namespace Lotus
{
	namespace Core
	{
		...
		public interface ILotusModelSelected
		{
			...
			//---------------------------------------------------------------------------------------------------------
			void SetModelSelected(ILotusViewModel viewModel, Boolean selected);
			...
			//---------------------------------------------------------------------------------------------------------
			Boolean CanModelSelected(ILotusViewModel viewModel);
		}
		...
		public interface ILotusModelEnabled
		{
			...
			//---------------------------------------------------------------------------------------------------------
			void SetModelEnabled(ILotusViewModel viewModel, Boolean enabled);
		}
		...
		public interface ILotusModelPresented
		{
			...
			//---------------------------------------------------------------------------------------------------------
			void SetModelPresented(ILotusViewModel viewModel, Boolean presented);
		}
		...
		public interface ILotusModelExpanded
		{
			...
			//---------------------------------------------------------------------------------------------------------
			void SetModelExpanded(ILotusViewModelHierarchy viewModel, Boolean expanded);
		}
