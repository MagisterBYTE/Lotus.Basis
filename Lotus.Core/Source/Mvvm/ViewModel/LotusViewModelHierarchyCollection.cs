...
namespace Lotus.Core
{
	...
	*@{*/
        ...
        where TModel : class
    {
        ...
        public CollectionViewModelHierarchy(string name, object source)
            : base(name, source)
        {
        }
        #endregion
        ...
        /// <returns>ViewModel.</returns>
        public virtual ILotusViewModelHierarchy CreateViewModelHierarchy(object model,
        ...
        public override bool OnNotifyUpdating(ILotusOwnedObject ownedObject, object? data, string dataName)
        {
            return true;
        }
        ...
        /// <param name="dataName">Имя данных.</param>
        public override void OnNotifyUpdated(ILotusOwnedObject ownedObject, object? data, string dataName)
        {
