	...
	namespace Core
	{
		...
		*@{*/
			...
			where TData : class
		{
			...
			/// <summary>
			/// Статус реализации типом интерейса <see cref="ILotusIdentifierLong"/>
			/// </summary>
			public static readonly Boolean IsSupportIdentifierLong = typeof(TData).IsSupportInterface<ILotusIdentifierLong>();
