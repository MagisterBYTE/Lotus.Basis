	...
	namespace Maths
	{
		...
		*@{*/
		...
		public static class XDistance2D
		{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single PointLine(in Vector2Df point, in Vector2Df linePos, in Vector2Df lineDir)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single PointRay(in Vector2Df point, in Vector2Df rayPos, in Vector2Df rayDir)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single PointCircle(in Vector2Df point, in Vector2Df circleCenter, Single circleRadius)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single LineLine(in Line2Df lineA, in Line2Df lineB)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single LineLine(in Vector2Df posA, in Vector2Df dirA, in Vector2Df posB,
				in Vector2Df dirB)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single LineRay(in Vector2Df linePos, in Vector2Df lineDir, in Vector2Df rayPos, in Vector2Df rayDir)
			{
				...
				if (ray_distance < -XGeometry2D.Eplsilon_f)
				{
					// No intersection
					var ray_pos_projection = Vector2Df.Dot(in lineDir, in ray_pos_to_line_pos);
					Vector2Df line_point = linePos - (lineDir * ray_pos_projection);
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single LineSegment(in Vector2Df linePos, in Vector2Df lineDir, in Vector2Df start, in Vector2Df end)
			{
				...
				if (segment_distance < -XGeometry2D.Eplsilon_f || segment_distance > 1 + XGeometry2D.Eplsilon_f)
				{
					...
					Vector2Df line_point = linePos + (lineDir * segmentPointProjection);
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single LineCircle(in Vector2Df linePos, in Vector2Df lineDir,
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single RayRay(in Ray2Df rayA, in Ray2Df rayB)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single RayRay(in Vector2Df posA, in Vector2Df dirA, in Vector2Df posB, 
				in Vector2Df dirB)
			{
				Vector2Df pos_b_to_a = posA - posB;
				...
				if (distance_a < -XGeometry2D.Eplsilon_f || distance_b < -XGeometry2D.Eplsilon_f)
				{
					...
					if (codirected)
					{
						...
						{
							Vector2Df ray_point_a = posA;
							Vector2Df ray_point_b = posB + (dirB * pos_a_projection);
							return Vector2Df.Distance(in ray_point_a, in ray_point_b);
						}
						var pos_b_projection = -Vector2Df.Dot(dirA, pos_b_to_a);
						if (pos_b_projection > -XGeometry2D.Eplsilon_f)
						{
							Vector2Df ray_point_a = posA + (dirA * pos_b_projection);
							Vector2Df ray_point_b = posB;
							return Vector2Df.Distance(in ray_point_a, in ray_point_b);
						}
						return Vector2Df.Distance(in posA, in posB);
					}
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single RaySegment(in Vector2Df rayPos, in Vector2Df rayDir, in Vector2Df start, in Vector2Df end)
			{
				...
				if (Math.Abs(denominator) < XGeometry2D.Eplsilon_f)
				{
					...
					Vector2Df originToSegmentB = end_copy - rayPos;
					...
					segment_distance < -XGeometry2D.Eplsilon_f || segment_distance > 1 + XGeometry2D.Eplsilon_f)
				{
					...
					if (segment_start_on_ray && segment_end_on_ray)
					{
						...
						{
							Vector2Df ray_point = rayPos + (rayDir * segment_start_projection);
							Vector2Df segment_point = start_copy;
							return Vector2Df.Distance(in ray_point, in segment_point);
						}
						else
						{
							Vector2Df ray_point = rayPos + (rayDir * segment_end_projection);
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single RayCircle(in Vector2Df rayPos, in Vector2Df rayDir, in Vector2Df circleCenter, 
				Single circleRadius)
			{
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single SegmentSegment(in Vector2Df segment1Start, in Vector2Df segment1End,
				in Vector2Df segment2Start, in Vector2Df segment2End)
			{
				...
				if (Math.Abs(denominator) < XGeometry2D.Eplsilon_f)
				{
					...
					if (Math.Abs(perpDot1) > XGeometry2D.Eplsilon_f || Math.Abs(perpDot2) > XGeometry2D.Eplsilon_f)
					{
						...
						Vector2Df from1ATo2B = segment2_end_copy - segment1Start;
			...
			/// <returns>Расстояние</returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single SegmentCircle(in Vector2Df start, in Vector2Df end, in Vector2Df circleCenter, Single circleRadius)
			{
			...
			/// </returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single CircleCircle(in Circle2Df circleA, in Circle2Df circleB)
			{
			...
			/// </returns>
			//---------------------------------------------------------------------------------------------------------
			public static Single CircleCircle(in Vector2Df centerA, Single radiusA, in Vector2Df centerB, 
				Single radiusB)
			{
