...
namespace Lotus
{
	namespace Object3D
	{
		...
		//! Подсистема трёхмерной полигональной сетки(меша) представляет собой совокупность данных предназначенных для 
		//! представления, хранения и генерации трёхмерной полигональной сетки
		//! \ingroup Object3D
		//-------------------------------------------------------------------------------------------------------------
		//! \defgroup Object3DMeshCommon Общее данные
		//! Общие данные содержат базовые представления структурных элементов трехмерной сетки
