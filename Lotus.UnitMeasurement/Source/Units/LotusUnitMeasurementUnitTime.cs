...
//---------------------------------------------------------------------------------------------------------------------
/** \file LotusUnitMeasurementUnitTime.cs
*		Определение основных единиц измерения времени.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
...
namespace Lotus
{
	namespace UnitMeasurement
	{
		...
		public static class XUnitTime
		{
			...
			/// </summary>
			public readonly static Dictionary<TUnitTime, CUnitDescriptorTime> Descriptors =
				new Dictionary<TUnitTime, CUnitDescriptorTime>()
			{
