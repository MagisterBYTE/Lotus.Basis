...
//---------------------------------------------------------------------------------------------------------------------
/** \file LotusUnitMeasurementUnitVolume.cs
*		Определение основных единиц измерения объема.
*/
//---------------------------------------------------------------------------------------------------------------------
// Версия: 1.0.0.0
	...
	namespace UnitMeasurement
	{
		...
		*@{*/
		...
		public static class XUnitVolume
		{
			...
			/// </summary>
			public readonly static Dictionary<TUnitVolume, CUnitDescriptorVolume> Descriptors =
				new Dictionary<TUnitVolume, CUnitDescriptorVolume>()
			{
